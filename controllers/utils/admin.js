...
document.querySelector('title').textContent = 'Streetweardrop - Dashboard';
                    ...
                    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
                        <div class="container">
                            <a class="navbar-brand" href="dashboard.html">
                                <img src="../../resources/img/logo.jpg" alt="Streetweardrop" width="50">
                            </a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarContent">
                                <ul class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="tipoProducto.html">Tipo Producto</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="distribuidor.html">Distribuidores</a>
                                    </li>
                                    <li class="nav-item">
